package com.example.laboratorio4_pdm_00229017.adapters
...
class MovieAdapter(var movies: List<Movie>, private val clickListener: (Movie) -> Unit): RecyclerView.Adapter<MovieAdapter.ViewHolder>() {
    ...
    class ViewHolder(itemView: View): RecyclerView.ViewHolder(itemView) {
        fun bind(item: Movie, clickListener: (Movie) -> Unit) = with(itemView) {
            ...
            movie_rate_cv.text = item.imbRating
